...
2. Tratar según que campos, por ejemplo los tags habrá que representarlos como un string y separados por comas, las etiquetas `<pre`> que indican código habrá que convertiras a shell.
